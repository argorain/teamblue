...
class ChecklistIntentHandler(AbstractRequestHandler):
    """Handler for Checklist Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("ChecklistIntent")(handler_input)
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Sorry, I had trouble doing what you asked. Please try again ." + exception
